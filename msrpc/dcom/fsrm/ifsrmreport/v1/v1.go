...
type xxx_DefaultReportClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultReportClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultReportClient) GetType(ctx context.Context, in *GetTypeRequest, opts ...dcerpc.CallOption) (*GetTypeResponse, error) {
...
func (o *xxx_DefaultReportClient) GetName(ctx context.Context, in *GetNameRequest, opts ...dcerpc.CallOption) (*GetNameResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) SetName(ctx context.Context, in *SetNameRequest, opts ...dcerpc.CallOption) (*SetNameResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) GetDescription(ctx context.Context, in *GetDescriptionRequest, opts ...dcerpc.CallOption) (*GetDescriptionResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) SetDescription(ctx context.Context, in *SetDescriptionRequest, opts ...dcerpc.CallOption) (*SetDescriptionResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) GetLastGeneratedFileNamePrefix(ctx context.Context, in *GetLastGeneratedFileNamePrefixRequest, opts ...dcerpc.CallOption) (*GetLastGeneratedFileNamePrefixResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
	...
	out := &GetLastGeneratedFileNamePrefixResponse{}
	out.xxx_FromOp(ctx, op)
	if op.Return != int32(0) {
		return out, fmt.Errorf("%s: %w", op.OpName(), errors.New(ctx, op.Return))
	}
...
func (o *xxx_DefaultReportClient) GetFilter(ctx context.Context, in *GetFilterRequest, opts ...dcerpc.CallOption) (*GetFilterResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) SetFilter(ctx context.Context, in *SetFilterRequest, opts ...dcerpc.CallOption) (*SetFilterResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) Delete(ctx context.Context, in *DeleteRequest, opts ...dcerpc.CallOption) (*DeleteResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultReportClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultReportClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultReportClient) IPID(ctx context.Context, ipid *dcom.IPID) ReportClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultReportClient{
...
func NewReportClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (ReportClient, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(ReportSyntaxV1_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetTypeOperation) OpNum() int { return 7 }

func (o *xxx_GetTypeOperation) OpName() string { return "/IFsrmReport/v1/Type" }
...
func (o *xxx_GetTypeOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// reportType {out, retval} (1:{pointer=ref}*(1))(2:{alias=FsrmReportType}(enum))
	{
...
func (o *xxx_GetNameOperation) OpName() string { return "/IFsrmReport/v1/Name" }
...
func (o *xxx_SetNameOperation) OpNum() int { return 9 }

func (o *xxx_SetNameOperation) OpName() string { return "/IFsrmReport/v1/Name" }
...
func (o *xxx_GetDescriptionOperation) OpName() string { return "/IFsrmReport/v1/Description" }
...
func (o *xxx_SetDescriptionOperation) OpName() string { return "/IFsrmReport/v1/Description" }
...
// xxx_GetLastGeneratedFileNamePrefixOperation structure represents the LastGeneratedFileNamePrefix operation
type xxx_GetLastGeneratedFileNamePrefixOperation struct {
	This   *dcom.ORPCThis `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat `idl:"name:That" json:"that"`
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) OpNum() int { return 12 }

func (o *xxx_GetLastGeneratedFileNamePrefixOperation) OpName() string {
	return "/IFsrmReport/v1/LastGeneratedFileNamePrefix"
}

func (o *xxx_GetLastGeneratedFileNamePrefixOperation) xxx_PrepareRequestPayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareRequestPayload(context.Context) error }); ok {
		if err := hook.AfterPrepareRequestPayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// prefix {out, retval} (1:{pointer=ref}*(2))(2:{pointer=unique, alias=BSTR}*(1))(3:{pointer=unique, alias=_BSTR, names=FLAGGED_WORD_BLOB}(struct))
	{
		if o.Prefix != nil {
...
func (o *xxx_GetLastGeneratedFileNamePrefixOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
	...
	// prefix {out, retval} (1:{pointer=ref}*(2))(2:{pointer=unique, alias=BSTR}*(1))(3:{pointer=unique, alias=_BSTR, names=FLAGGED_WORD_BLOB}(struct))
	{
		...
		_s_prefix := func(ptr interface{}) { o.Prefix = *ptr.(**oaut.String) }
...
func (o *GetLastGeneratedFileNamePrefixRequest) xxx_ToOp(ctx context.Context, op *xxx_GetLastGeneratedFileNamePrefixOperation) *xxx_GetLastGeneratedFileNamePrefixOperation {
	if op == nil {
...
func (o *GetLastGeneratedFileNamePrefixRequest) xxx_FromOp(ctx context.Context, op *xxx_GetLastGeneratedFileNamePrefixOperation) {
	if o == nil {
		return
	}
	o.This = op.This
}
func (o *GetLastGeneratedFileNamePrefixRequest) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRRequest(ctx, w)
}
func (o *GetLastGeneratedFileNamePrefixRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetLastGeneratedFileNamePrefixOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
func (o *GetLastGeneratedFileNamePrefixResponse) xxx_ToOp(ctx context.Context, op *xxx_GetLastGeneratedFileNamePrefixOperation) *xxx_GetLastGeneratedFileNamePrefixOperation {
	if op == nil {
		op = &xxx_GetLastGeneratedFileNamePrefixOperation{}
	}
	if o == nil {
...
func (o *GetLastGeneratedFileNamePrefixResponse) xxx_FromOp(ctx context.Context, op *xxx_GetLastGeneratedFileNamePrefixOperation) {
	if o == nil {
		return
	}
	o.That = op.That
...
func (o *GetLastGeneratedFileNamePrefixResponse) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx, nil).MarshalNDRResponse(ctx, w)
}
func (o *GetLastGeneratedFileNamePrefixResponse) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetLastGeneratedFileNamePrefixOperation{}
	if err := _o.UnmarshalNDRResponse(ctx, r); err != nil {
		return err
	}
...
func (o *xxx_GetFilterOperation) OpNum() int { return 13 }

func (o *xxx_GetFilterOperation) OpName() string { return "/IFsrmReport/v1/GetFilter" }
...
func (o *xxx_SetFilterOperation) OpNum() int { return 14 }

func (o *xxx_SetFilterOperation) OpName() string { return "/IFsrmReport/v1/SetFilter" }
...
func (o *xxx_DeleteOperation) OpNum() int { return 15 }

func (o *xxx_DeleteOperation) OpName() string { return "/IFsrmReport/v1/Delete" }
