...
type xxx_DefaultPropertyClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultPropertyClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultPropertyClient) GetName(ctx context.Context, in *GetNameRequest, opts ...dcerpc.CallOption) (*GetNameResponse, error) {
...
func (o *xxx_DefaultPropertyClient) GetValue(ctx context.Context, in *GetValueRequest, opts ...dcerpc.CallOption) (*GetValueResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultPropertyClient) GetSources(ctx context.Context, in *GetSourcesRequest, opts ...dcerpc.CallOption) (*GetSourcesResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultPropertyClient) GetPropertyFlags(ctx context.Context, in *GetPropertyFlagsRequest, opts ...dcerpc.CallOption) (*GetPropertyFlagsResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultPropertyClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultPropertyClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultPropertyClient) IPID(ctx context.Context, ipid *dcom.IPID) PropertyClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultPropertyClient{
...
func NewPropertyClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (PropertyClient, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(PropertySyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
// xxx_GetSourcesOperation structure represents the Sources operation
type xxx_GetSourcesOperation struct {
	This    *dcom.ORPCThis  `idl:"name:This" json:"this"`
	That    *dcom.ORPCThat  `idl:"name:That" json:"that"`
...
func (o *xxx_GetSourcesOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_GetSourcesOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_GetSourcesOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetSourcesOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// sources {out, retval} (1:{pointer=ref}*(2))(2:{pointer=unique, alias=SAFEARRAY}*(1))(3:{pointer=unique, alias=_SAFEARRAY}(struct))
	{
		if o.Sources != nil {
			_ptr_sources := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Sources != nil {
					if err := o.Sources.MarshalNDR(ctx, w); err != nil {
						return err
					}
				} else {
			...
			if err := w.WritePointer(&o.Sources, _ptr_sources); err != nil {
				return err
			}
		} else {
			if err := w.WritePointer(nil); err != nil {
...
func (o *xxx_GetSourcesOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
	...
	// sources {out, retval} (1:{pointer=ref}*(2))(2:{pointer=unique, alias=SAFEARRAY}*(1))(3:{pointer=unique, alias=_SAFEARRAY}(struct))
	{
		_ptr_sources := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.Sources == nil {
				o.Sources = &oaut.SafeArray{}
			}
			if err := o.Sources.UnmarshalNDR(ctx, w); err != nil {
				return err
			}
			return nil
		})
		_s_sources := func(ptr interface{}) { o.Sources = *ptr.(**oaut.SafeArray) }
		if err := w.ReadPointer(&o.Sources, _s_sources, _ptr_sources); err != nil {
			return err
		}
		if err := w.ReadDeferred(); err != nil {
			return err
...
func (o *GetSourcesRequest) xxx_ToOp(ctx context.Context, op *xxx_GetSourcesOperation) *xxx_GetSourcesOperation {
	if op == nil {
...
func (o *GetSourcesRequest) xxx_FromOp(ctx context.Context, op *xxx_GetSourcesOperation) {
	if o == nil {
		return
	}
	o.This = op.This
...
func (o *GetSourcesResponse) xxx_ToOp(ctx context.Context, op *xxx_GetSourcesOperation) *xxx_GetSourcesOperation {
	if op == nil {
		op = &xxx_GetSourcesOperation{}
	}
	if o == nil {
...
func (o *GetSourcesResponse) xxx_FromOp(ctx context.Context, op *xxx_GetSourcesOperation) {
	if o == nil {
		return
	}
	o.That = op.That
...
// xxx_GetPropertyFlagsOperation structure represents the PropertyFlags operation
type xxx_GetPropertyFlagsOperation struct {
	This   *dcom.ORPCThis `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat `idl:"name:That" json:"that"`
...
func (o *xxx_GetPropertyFlagsOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_GetPropertyFlagsOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_GetPropertyFlagsOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetPropertyFlagsOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// flags {out, retval} (1:{pointer=ref}*(1)(int32))
	{
...
func (o *xxx_GetPropertyFlagsOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
...
func (o *GetPropertyFlagsRequest) xxx_ToOp(ctx context.Context, op *xxx_GetPropertyFlagsOperation) *xxx_GetPropertyFlagsOperation {
	if op == nil {
...
func (o *GetPropertyFlagsRequest) xxx_FromOp(ctx context.Context, op *xxx_GetPropertyFlagsOperation) {
	if o == nil {
		return
	}
	o.This = op.This
...
func (o *GetPropertyFlagsRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetPropertyFlagsOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
func (o *GetPropertyFlagsResponse) xxx_ToOp(ctx context.Context, op *xxx_GetPropertyFlagsOperation) *xxx_GetPropertyFlagsOperation {
	if op == nil {
		op = &xxx_GetPropertyFlagsOperation{}
	}
	if o == nil {
...
func (o *GetPropertyFlagsResponse) xxx_FromOp(ctx context.Context, op *xxx_GetPropertyFlagsOperation) {
	if o == nil {
		return
	}
	o.That = op.That
