...
type xxx_DefaultEnumObjectClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultEnumObjectClient) Unknown() iunknown.UnknownClient {
...
func (o *xxx_DefaultEnumObjectClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
...
func (o *xxx_DefaultEnumObjectClient) IPID(ctx context.Context, ipid *dcom.IPID) EnumObjectClient {
	...
	return &xxx_DefaultEnumObjectClient{
...
func NewEnumObjectClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (EnumObjectClient, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(EnumObjectSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumVdsObject/v0/Next" }
...
func (o *xxx_NextOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if o.ObjectArray != nil && o.FetchedCount == 0 {
		o.FetchedCount = uint32(len(o.ObjectArray))
	}
...
func (o *xxx_NextOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppObjectArray {out} (1:{pointer=ref}*(1)[dim:0,size_is=celt,length_is=pcFetched]*(1))(2:{alias=IUnknown}(interface))
	{
		...
		for i1 := range o.ObjectArray {
			...
			if o.ObjectArray[i1] != nil {
				_ptr_ppObjectArray := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
					if o.ObjectArray[i1] != nil {
				...
				if err := w.WritePointer(&o.ObjectArray[i1], _ptr_ppObjectArray); err != nil {
					return err
				}
			} else {
	...
	// pcFetched {out} (1:{pointer=ref}*(1)(uint32))
	{
...
func (o *xxx_NextOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppObjectArray {out} (1:{pointer=ref}*(1)[dim:0,size_is=celt,length_is=pcFetched]*(1))(2:{alias=IUnknown}(interface))
	{
		...
		o.ObjectArray = make([]*dcom.Unknown, sizeInfo[0])
		for i1 := range o.ObjectArray {
			i1 := i1
			_ptr_ppObjectArray := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
				if o.ObjectArray[i1] == nil {
					o.ObjectArray[i1] = &dcom.Unknown{}
				}
			...
			_s_ppObjectArray := func(ptr interface{}) { o.ObjectArray[i1] = *ptr.(**dcom.Unknown) }
			if err := w.ReadPointer(&o.ObjectArray[i1], _s_ppObjectArray, _ptr_ppObjectArray); err != nil {
				return err
			}
		}
		if err := w.ReadDeferred(); err != nil {
...
func (o *xxx_SkipOperation) OpName() string { return "/IEnumVdsObject/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IEnumVdsObject/v0/Reset" }
...
func (o *xxx_CloneOperation) OpName() string { return "/IEnumVdsObject/v0/Clone" }
