...
type xxx_DefaultDataCollectorSetCollectionClient struct {
	idispatch.DispatchClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultDataCollectorSetCollectionClient) Dispatch() idispatch.DispatchClient {
	return o.DispatchClient
}

func (o *xxx_DefaultDataCollectorSetCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
	op := in.xxx_ToOp(ctx)
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) Get_NewEnum(ctx context.Context, in *Get_NewEnumRequest, opts ...dcerpc.CallOption) (*Get_NewEnumResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) Add(ctx context.Context, in *AddRequest, opts ...dcerpc.CallOption) (*AddResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) Remove(ctx context.Context, in *RemoveRequest, opts ...dcerpc.CallOption) (*RemoveResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) Clear(ctx context.Context, in *ClearRequest, opts ...dcerpc.CallOption) (*ClearResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) AddRange(ctx context.Context, in *AddRangeRequest, opts ...dcerpc.CallOption) (*AddRangeResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) GetDataCollectorSets(ctx context.Context, in *GetDataCollectorSetsRequest, opts ...dcerpc.CallOption) (*GetDataCollectorSetsResponse, error) {
	op := in.xxx_ToOp(ctx)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultDataCollectorSetCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultDataCollectorSetCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) DataCollectorSetCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultDataCollectorSetCollectionClient{
...
func NewDataCollectorSetCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (DataCollectorSetCollectionClient, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(DataCollectorSetCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetCountOperation) OpName() string { return "/IDataCollectorSetCollection/v0/Count" }
...
func (o *xxx_GetItemOperation) OpName() string { return "/IDataCollectorSetCollection/v0/Item" }
...
func (o *xxx_GetItemOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// set {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IDataCollectorSet}(interface))
	{
		if o.Set != nil {
			_ptr_set := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Set != nil {
					if err := o.Set.MarshalNDR(ctx, w); err != nil {
						return err
					}
				} else {
			...
			if err := w.WritePointer(&o.Set, _ptr_set); err != nil {
				return err
			}
		} else {
...
func (o *xxx_GetItemOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// set {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IDataCollectorSet}(interface))
	{
		_ptr_set := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.Set == nil {
				o.Set = &pla.DataCollectorSet{}
			}
			if err := o.Set.UnmarshalNDR(ctx, w); err != nil {
				return err
			}
			return nil
		})
		_s_set := func(ptr interface{}) { o.Set = *ptr.(**pla.DataCollectorSet) }
		if err := w.ReadPointer(&o.Set, _s_set, _ptr_set); err != nil {
			return err
		}
		if err := w.ReadDeferred(); err != nil {
			return err
...
func (o *xxx_Get_NewEnumOperation) OpName() string { return "/IDataCollectorSetCollection/v0/_NewEnum" }
...
func (o *xxx_AddOperation) OpName() string { return "/IDataCollectorSetCollection/v0/Add" }
...
func (o *xxx_AddOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	...
	// set {in} (1:{pointer=ref}*(1))(2:{alias=IDataCollectorSet}(interface))
	{
		if o.Set != nil {
			_ptr_set := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Set != nil {
...
func (o *xxx_RemoveOperation) OpName() string { return "/IDataCollectorSetCollection/v0/Remove" }
...
func (o *xxx_RemoveOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	...
	// set {in} (1:{alias=VARIANT}*(1))(2:{alias=_VARIANT}(struct))
	{
		if o.Set != nil {
			if err := o.Set.MarshalNDR(ctx, w); err != nil {
				return err
...
func (o *xxx_RemoveOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	...
	// set {in} (1:{alias=VARIANT,pointer=ref}*(1))(2:{alias=_VARIANT}(struct))
	{
		if o.Set == nil {
			o.Set = &oaut.Variant{}
		}
...
func (o *xxx_ClearOperation) OpName() string { return "/IDataCollectorSetCollection/v0/Clear" }
...
func (o *xxx_AddRangeOperation) OpName() string { return "/IDataCollectorSetCollection/v0/AddRange" }
...
func (o *xxx_AddRangeOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	...
	// sets {in} (1:{pointer=ref}*(1))(2:{alias=IDataCollectorSetCollection}(interface))
	{
		if o.Sets != nil {
			_ptr_sets := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Sets != nil {
					if err := o.Sets.MarshalNDR(ctx, w); err != nil {
						return err
					}
				} else {
					if err := (&pla.DataCollectorSetCollection{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
			})
			if err := w.WritePointer(&o.Sets, _ptr_sets); err != nil {
				return err
			}
		} else {
			if err := w.WritePointer(nil); err != nil {
...
func (o *xxx_AddRangeOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	...
	// sets {in} (1:{pointer=ref}*(1))(2:{alias=IDataCollectorSetCollection}(interface))
	{
		_ptr_sets := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.Sets == nil {
				o.Sets = &pla.DataCollectorSetCollection{}
			}
			if err := o.Sets.UnmarshalNDR(ctx, w); err != nil {
				return err
			}
			return nil
		})
		_s_sets := func(ptr interface{}) { o.Sets = *ptr.(**pla.DataCollectorSetCollection) }
		if err := w.ReadPointer(&o.Sets, _s_sets, _ptr_sets); err != nil {
			return err
		}
		if err := w.ReadDeferred(); err != nil {
			return err
...
// xxx_GetDataCollectorSetsOperation structure represents the GetDataCollectorSets operation
type xxx_GetDataCollectorSetsOperation struct {
	This   *dcom.ORPCThis `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat `idl:"name:That" json:"that"`
...
func (o *xxx_GetDataCollectorSetsOperation) OpNum() int { return 14 }

func (o *xxx_GetDataCollectorSetsOperation) OpName() string {
	return "/IDataCollectorSetCollection/v0/GetDataCollectorSets"
}

func (o *xxx_GetDataCollectorSetsOperation) xxx_PrepareRequestPayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareRequestPayload(context.Context) error }); ok {
		if err := hook.AfterPrepareRequestPayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetDataCollectorSetsOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
	...
	// filter {in} (1:{pointer=unique, alias=BSTR, pointers=[unique]}*(1))(2:{pointer=unique, alias=_BSTR, names=FLAGGED_WORD_BLOB}(struct))
	{
		if o.Filter != nil {
...
func (o *xxx_GetDataCollectorSetsOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
	...
	// filter {in} (1:{pointer=unique, alias=BSTR, pointers=[unique]}*(1))(2:{pointer=unique, alias=_BSTR, names=FLAGGED_WORD_BLOB}(struct))
	{
		...
		_s_filter := func(ptr interface{}) { o.Filter = *ptr.(**oaut.String) }
...
func (o *xxx_GetDataCollectorSetsOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetDataCollectorSetsOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
...
func (o *xxx_GetDataCollectorSetsOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
...
func (o *GetDataCollectorSetsRequest) xxx_ToOp(ctx context.Context) *xxx_GetDataCollectorSetsOperation {
	if o == nil {
		return &xxx_GetDataCollectorSetsOperation{}
	}
	return &xxx_GetDataCollectorSetsOperation{
		This:   o.This,
		Server: o.Server,
...
func (o *GetDataCollectorSetsRequest) xxx_FromOp(ctx context.Context, op *xxx_GetDataCollectorSetsOperation) {
	if o == nil {
		return
	}
	o.This = op.This
...
func (o *GetDataCollectorSetsRequest) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx).MarshalNDRRequest(ctx, w)
}
func (o *GetDataCollectorSetsRequest) UnmarshalNDR(ctx context.Context, r ndr.Reader) error {
	_o := &xxx_GetDataCollectorSetsOperation{}
	if err := _o.UnmarshalNDRRequest(ctx, r); err != nil {
		return err
	}
	o.xxx_FromOp(ctx, _o)
...
func (o *GetDataCollectorSetsResponse) xxx_ToOp(ctx context.Context) *xxx_GetDataCollectorSetsOperation {
	if o == nil {
		return &xxx_GetDataCollectorSetsOperation{}
	}
	return &xxx_GetDataCollectorSetsOperation{
...
func (o *GetDataCollectorSetsResponse) xxx_FromOp(ctx context.Context, op *xxx_GetDataCollectorSetsOperation) {
	if o == nil {
		return
	}
	o.That = op.That
...
func (o *GetDataCollectorSetsResponse) MarshalNDR(ctx context.Context, w ndr.Writer) error {
	return o.xxx_ToOp(ctx).MarshalNDRResponse(ctx, w)
}
