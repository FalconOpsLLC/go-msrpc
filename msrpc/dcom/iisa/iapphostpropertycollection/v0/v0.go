...
var (
	// IAppHostPropertyCollection interface identifier 0191775e-bcff-445a-b4f4-3bdda54e2816
	AppHostPropertyCollectionIID = &dcom.IID{Data1: 0x0191775e, Data2: 0xbcff, Data3: 0x445a, Data4: []byte{0xb4, 0xf4, 0x3b, 0xdd, 0xa5, 0x4e, 0x28, 0x16}}
	// Syntax UUID
	AppHostPropertyCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0x191775e, TimeMid: 0xbcff, TimeHiAndVersion: 0x445a, ClockSeqHiAndReserved: 0xb4, ClockSeqLow: 0xf4, Node: [6]uint8{0x3b, 0xdd, 0xa5, 0x4e, 0x28, 0x16}}
	// Syntax ID
	AppHostPropertyCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: AppHostPropertyCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IAppHostPropertyCollection interface.
type AppHostPropertyCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) AppHostPropertyCollectionClient
}

type xxx_DefaultAppHostPropertyCollectionClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultAppHostPropertyCollectionClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultAppHostPropertyCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
...
func (o *xxx_DefaultAppHostPropertyCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostPropertyCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultAppHostPropertyCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultAppHostPropertyCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) AppHostPropertyCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultAppHostPropertyCollectionClient{
...
func NewAppHostPropertyCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (AppHostPropertyCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(AppHostPropertyCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetCountOperation) OpName() string { return "/IAppHostPropertyCollection/v0/Count" }
...
func (o *xxx_GetItemOperation) OpName() string { return "/IAppHostPropertyCollection/v0/Item" }
