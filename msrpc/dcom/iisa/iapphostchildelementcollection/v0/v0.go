...
var (
	// IAppHostChildElementCollection interface identifier 08a90f5f-0702-48d6-b45f-02a9885a9768
	AppHostChildElementCollectionIID = &dcom.IID{Data1: 0x08a90f5f, Data2: 0x0702, Data3: 0x48d6, Data4: []byte{0xb4, 0x5f, 0x02, 0xa9, 0x88, 0x5a, 0x97, 0x68}}
	// Syntax UUID
	AppHostChildElementCollectionSyntaxUUID = &uuid.UUID{TimeLow: 0x8a90f5f, TimeMid: 0x702, TimeHiAndVersion: 0x48d6, ClockSeqHiAndReserved: 0xb4, ClockSeqLow: 0x5f, Node: [6]uint8{0x2, 0xa9, 0x88, 0x5a, 0x97, 0x68}}
	// Syntax ID
	AppHostChildElementCollectionSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: AppHostChildElementCollectionSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IAppHostChildElementCollection interface.
type AppHostChildElementCollectionClient interface {
	...
	IPID(context.Context, *dcom.IPID) AppHostChildElementCollectionClient
}

type xxx_DefaultAppHostChildElementCollectionClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultAppHostChildElementCollectionClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultAppHostChildElementCollectionClient) GetCount(ctx context.Context, in *GetCountRequest, opts ...dcerpc.CallOption) (*GetCountResponse, error) {
...
func (o *xxx_DefaultAppHostChildElementCollectionClient) GetItem(ctx context.Context, in *GetItemRequest, opts ...dcerpc.CallOption) (*GetItemResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostChildElementCollectionClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultAppHostChildElementCollectionClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultAppHostChildElementCollectionClient) IPID(ctx context.Context, ipid *dcom.IPID) AppHostChildElementCollectionClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultAppHostChildElementCollectionClient{
...
func NewAppHostChildElementCollectionClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (AppHostChildElementCollectionClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(AppHostChildElementCollectionSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_GetCountOperation) OpName() string { return "/IAppHostChildElementCollection/v0/Count" }
...
func (o *xxx_GetItemOperation) OpName() string { return "/IAppHostChildElementCollection/v0/Item" }
