...
import (
	...
	iisa "github.com/FalconOpsLLC/go-msrpc/msrpc/dcom/iisa"
...
type xxx_DefaultAppHostMethodInstanceClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultAppHostMethodInstanceClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultAppHostMethodInstanceClient) GetInput(ctx context.Context, in *GetInputRequest, opts ...dcerpc.CallOption) (*GetInputResponse, error) {
...
func (o *xxx_DefaultAppHostMethodInstanceClient) GetOutput(ctx context.Context, in *GetOutputRequest, opts ...dcerpc.CallOption) (*GetOutputResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostMethodInstanceClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...dcerpc.CallOption) (*ExecuteResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostMethodInstanceClient) GetMetadata(ctx context.Context, in *GetMetadataRequest, opts ...dcerpc.CallOption) (*GetMetadataResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostMethodInstanceClient) SetMetadata(ctx context.Context, in *SetMetadataRequest, opts ...dcerpc.CallOption) (*SetMetadataResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultAppHostMethodInstanceClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultAppHostMethodInstanceClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultAppHostMethodInstanceClient) IPID(ctx context.Context, ipid *dcom.IPID) AppHostMethodInstanceClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultAppHostMethodInstanceClient{
...
func NewAppHostMethodInstanceClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (AppHostMethodInstanceClient, error) {
	...
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(AppHostMethodInstanceSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
// xxx_GetInputOperation structure represents the Input operation
type xxx_GetInputOperation struct {
...
func (o *xxx_GetInputOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
...
func (o *xxx_GetInputOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
...
func (o *xxx_GetInputOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
...
func (o *xxx_GetInputOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	...
	// ppInputElement {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IAppHostElement}(interface))
	{
		if o.InputElement != nil {
			_ptr_ppInputElement := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.InputElement != nil {
					if err := o.InputElement.MarshalNDR(ctx, w); err != nil {
						return err
					}
				} else {
			...
			if err := w.WritePointer(&o.InputElement, _ptr_ppInputElement); err != nil {
				return err
			}
		} else {
...
func (o *xxx_GetInputOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
	...
	// ppInputElement {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IAppHostElement}(interface))
	{
		_ptr_ppInputElement := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.InputElement == nil {
				o.InputElement = &iisa.AppHostElement{}
			}
			if err := o.InputElement.UnmarshalNDR(ctx, w); err != nil {
				return err
			}
			return nil
		})
		_s_ppInputElement := func(ptr interface{}) { o.InputElement = *ptr.(**iisa.AppHostElement) }
		if err := w.ReadPointer(&o.InputElement, _s_ppInputElement, _ptr_ppInputElement); err != nil {
			return err
		}
		if err := w.ReadDeferred(); err != nil {
			return err
...
func (o *GetInputRequest) xxx_ToOp(ctx context.Context, op *xxx_GetInputOperation) *xxx_GetInputOperation {
	if op == nil {
...
func (o *GetInputRequest) xxx_FromOp(ctx context.Context, op *xxx_GetInputOperation) {
	if o == nil {
		return
	}
	o.This = op.This
...
func (o *GetInputResponse) xxx_ToOp(ctx context.Context, op *xxx_GetInputOperation) *xxx_GetInputOperation {
	if op == nil {
		op = &xxx_GetInputOperation{}
	}
	if o == nil {
...
func (o *GetInputResponse) xxx_FromOp(ctx context.Context, op *xxx_GetInputOperation) {
	if o == nil {
		return
	}
	o.That = op.That
...
// xxx_GetOutputOperation structure represents the Output operation
type xxx_GetOutputOperation struct {
	This          *dcom.ORPCThis       `idl:"name:This" json:"this"`
	That          *dcom.ORPCThat       `idl:"name:That" json:"that"`
...
func (o *xxx_GetOutputOperation) MarshalNDRRequest(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareRequestPayload(ctx); err != nil {
		return err
	}
	// This {in} (1:{alias=ORPCTHIS}(struct))
...
func (o *xxx_GetOutputOperation) UnmarshalNDRRequest(ctx context.Context, w ndr.Reader) error {
	// This {in} (1:{alias=ORPCTHIS}(struct))
	{
		if o.This == nil {
			o.This = &dcom.ORPCThis{}
...
func (o *xxx_GetOutputOperation) xxx_PrepareResponsePayload(ctx context.Context) error {
	if hook, ok := (interface{})(o).(interface{ AfterPrepareResponsePayload(context.Context) error }); ok {
		if err := hook.AfterPrepareResponsePayload(ctx); err != nil {
			return err
		}
...
func (o *xxx_GetOutputOperation) MarshalNDRResponse(ctx context.Context, w ndr.Writer) error {
	if err := o.xxx_PrepareResponsePayload(ctx); err != nil {
		return err
	}
	// That {out} (1:{alias=ORPCTHAT}(struct))
	...
	// ppOutputElement {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IAppHostElement}(interface))
	{
		if o.OutputElement != nil {
			_ptr_ppOutputElement := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.OutputElement != nil {
					if err := o.OutputElement.MarshalNDR(ctx, w); err != nil {
						return err
					}
				} else {
					if err := (&iisa.AppHostElement{}).MarshalNDR(ctx, w); err != nil {
			...
			if err := w.WritePointer(&o.OutputElement, _ptr_ppOutputElement); err != nil {
				return err
			}
		} else {
			if err := w.WritePointer(nil); err != nil {
...
func (o *xxx_GetOutputOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	// That {out} (1:{alias=ORPCTHAT}(struct))
	{
		if o.That == nil {
			o.That = &dcom.ORPCThat{}
	...
	// ppOutputElement {out, retval} (1:{pointer=ref}*(2)*(1))(2:{alias=IAppHostElement}(interface))
	{
		_ptr_ppOutputElement := ndr.UnmarshalNDRFunc(func(ctx context.Context, w ndr.Reader) error {
			if o.OutputElement == nil {
				o.OutputElement = &iisa.AppHostElement{}
			}
			if err := o.OutputElement.UnmarshalNDR(ctx, w); err != nil {
				return err
			}
			return nil
		})
		_s_ppOutputElement := func(ptr interface{}) { o.OutputElement = *ptr.(**iisa.AppHostElement) }
		if err := w.ReadPointer(&o.OutputElement, _s_ppOutputElement, _ptr_ppOutputElement); err != nil {
			return err
		}
		if err := w.ReadDeferred(); err != nil {
			return err
...
func (o *GetOutputRequest) xxx_ToOp(ctx context.Context, op *xxx_GetOutputOperation) *xxx_GetOutputOperation {
	if op == nil {
...
func (o *GetOutputRequest) xxx_FromOp(ctx context.Context, op *xxx_GetOutputOperation) {
	if o == nil {
		return
	}
	o.This = op.This
...
func (o *GetOutputResponse) xxx_ToOp(ctx context.Context, op *xxx_GetOutputOperation) *xxx_GetOutputOperation {
	if op == nil {
		op = &xxx_GetOutputOperation{}
	}
	if o == nil {
...
func (o *GetOutputResponse) xxx_FromOp(ctx context.Context, op *xxx_GetOutputOperation) {
	if o == nil {
		return
	}
	o.That = op.That
