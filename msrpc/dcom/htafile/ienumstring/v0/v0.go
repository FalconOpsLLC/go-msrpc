...
var (
	// IEnumString interface identifier 00000101-0000-0000-c000-000000000046
	EnumStringIID = &dcom.IID{Data1: 0x00000101, Data2: 0x0000, Data3: 0x0000, Data4: []byte{0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}
	// Syntax UUID
	EnumStringSyntaxUUID = &uuid.UUID{TimeLow: 0x101, TimeMid: 0x0, TimeHiAndVersion: 0x0, ClockSeqHiAndReserved: 0xc0, ClockSeqLow: 0x0, Node: [6]uint8{0x0, 0x0, 0x0, 0x0, 0x0, 0x46}}
	// Syntax ID
	EnumStringSyntaxV0_0 = &dcerpc.SyntaxID{IfUUID: EnumStringSyntaxUUID, IfVersionMajor: 0, IfVersionMinor: 0}
)

// IEnumString interface.
type EnumStringClient interface {
	...
	IPID(context.Context, *dcom.IPID) EnumStringClient
}

type xxx_DefaultEnumStringClient struct {
	iunknown.UnknownClient
	cc   dcerpc.Conn
	ipid *dcom.IPID
}

func (o *xxx_DefaultEnumStringClient) Unknown() iunknown.UnknownClient {
	return o.UnknownClient
}

func (o *xxx_DefaultEnumStringClient) Next(ctx context.Context, in *NextRequest, opts ...dcerpc.CallOption) (*NextResponse, error) {
...
func (o *xxx_DefaultEnumStringClient) Skip(ctx context.Context, in *SkipRequest, opts ...dcerpc.CallOption) (*SkipResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumStringClient) Reset(ctx context.Context, in *ResetRequest, opts ...dcerpc.CallOption) (*ResetResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumStringClient) Clone(ctx context.Context, in *CloneRequest, opts ...dcerpc.CallOption) (*CloneResponse, error) {
	op := in.xxx_ToOp(ctx, nil)
	if _, ok := dcom.HasIPID(opts); !ok {
		if o.ipid != nil {
			opts = append(opts, dcom.WithIPID(o.ipid))
...
func (o *xxx_DefaultEnumStringClient) AlterContext(ctx context.Context, opts ...dcerpc.Option) error {
	return o.cc.AlterContext(ctx, opts...)
}

func (o *xxx_DefaultEnumStringClient) Conn() dcerpc.Conn {
	return o.cc
}

func (o *xxx_DefaultEnumStringClient) IPID(ctx context.Context, ipid *dcom.IPID) EnumStringClient {
	if ipid == nil {
		ipid = &dcom.IPID{}
	}
	return &xxx_DefaultEnumStringClient{
...
func NewEnumStringClient(ctx context.Context, cc dcerpc.Conn, opts ...dcerpc.Option) (EnumStringClient, error) {
	var err error
	if !dcom.IsSuperclass(opts) {
		cc, err = cc.Bind(ctx, append(opts, dcerpc.WithAbstractSyntax(EnumStringSyntaxV0_0))...)
		if err != nil {
			return nil, err
		}
	}
...
func (o *xxx_NextOperation) OpName() string { return "/IEnumString/v0/Next" }
...
func (o *xxx_SkipOperation) OpName() string { return "/IEnumString/v0/Skip" }
...
func (o *xxx_ResetOperation) OpName() string { return "/IEnumString/v0/Reset" }
...
type xxx_CloneOperation struct {
	This   *dcom.ORPCThis      `idl:"name:This" json:"this"`
	That   *dcom.ORPCThat      `idl:"name:That" json:"that"`
	Ppenum *htafile.EnumString `idl:"name:ppenum" json:"ppenum"`
	Return int32               `idl:"name:Return" json:"return"`
}

func (o *xxx_CloneOperation) OpNum() int { return 6 }

func (o *xxx_CloneOperation) OpName() string { return "/IEnumString/v0/Clone" }
		...
		if o.Ppenum != nil {
			_ptr_ppenum := ndr.MarshalNDRFunc(func(ctx context.Context, w ndr.Writer) error {
				if o.Ppenum != nil {
					...
					if err := (&htafile.EnumString{}).MarshalNDR(ctx, w); err != nil {
						return err
					}
				}
				return nil
...
func (o *xxx_CloneOperation) UnmarshalNDRResponse(ctx context.Context, w ndr.Reader) error {
	...
	// ppenum {out} (1:{pointer=ref}*(2)*(1))(2:{alias=IEnumString}(interface))
	{
		...
		_s_ppenum := func(ptr interface{}) { o.Ppenum = *ptr.(**htafile.EnumString) }
